...
class MultiThreadFaceAnalysis:
    def __init__(self, test_folder: str = 'test_01',
                 camera_params: dict = None, identifier_params: dict = None):
        self.show_times = 0
        camera_params = {'app': '', 'approach': '', 'test_folder': test_folder,
                         'resolution': (1920, 1080), 'fps': 30} | camera_params
        identifier_params = {'server_refresh': False, 'npz_refresh': False, 'flush_threshold': 1000} | identifier_params
